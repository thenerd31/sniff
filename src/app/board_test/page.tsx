...
const mockChecks: Record<string, FraudCheck[]> = {
  p1: [
    ...
    { name: "Seller Verification", status: "passed", detail: "Sold and shipped by Amazon.com. Verified business entity.", severity: 0.03 },
  ],
  p2: [
    ...
    { name: "Seller Verification", status: "failed", detail: "No business registration found. WHOIS privacy enabled.", severity: 0.88 },
  ],
  p3: [
    ...
    { name: "Seller Verification", status: "passed", detail: "Publicly traded company (NYSE: BBY). Verified entity.", severity: 0.02 },
  ],
  p4: [
    ...
    { name: "Seller Verification", status: "failed", detail: "No business entity. Uses .xyz TLD common in scam sites.", severity: 0.96 },
  ],
  p5: [
    ...
    { name: "Seller Verification", status: "passed", detail: "Authorized Sony dealer. Verified business with physical store.", severity: 0.03 },
  ],
  p6: [
    ...
    { name: "Seller Verification", status: "warning", detail: "Small business registration found, but no physical address.", severity: 0.48 },
  ],
  p7: [
    ...
    { name: "Seller Verification", status: "passed", detail: "Fortune 1 company (NYSE: WMT). Verified entity.", severity: 0.02 },
  ],
  p8: [
    ...
    { name: "Seller Verification", status: "failed", detail: "Fake address listed. No business registration found.", severity: 0.93 },
  ],
};
